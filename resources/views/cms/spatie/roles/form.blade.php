...
@section('page-name','إضافة دور وظيفي جديد')

@section('small-page-name','إضافة دور وظيفي')
...
<div class="col-md-12">
  ...
  <div class="card card-primary" id="form-card">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="create-form" role="form" method="POST" action="{{route('roles.store')}}">
      ...
      <div class="card-body">
        ...
        <div class="form-group ">
          ...
          <input type="text" name="name" class="form-control" placeholder="ادخل اسم الدور وظيفي">
        </div>
