...
@section('page-name','تعديل الصلاحية ')

@section('small-page-name','تعديل الصلاحية')
  ...
  <div class="card card-primary" id="form-card">
    ...
    <form id="create-form">
      ...
      <div class="card-body">
        ...
        <div class="form-group col-md-6">
          ...
          <select class="form-control guards" id="guards" style="width: 82%">
            <option value="web" @if($permission->guard_name =='web') selected @endif >مستخدمين</option>
            <option value="admin" @if($permission->guard_name =='admin') selected @endif>مشرفين</option>
          </select>
        </div>
      ...
      <div class="card-footer">
        <button onclick="performUpdate({{$permission->id}})" class="btn btn-primary">تعديل</b utton>
      </div>
    </form>
  </div>
  <!-- /.card -->
