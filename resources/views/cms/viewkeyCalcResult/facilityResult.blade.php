...
@section('page-name','عرض النتائج حسب المرفق')
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">اسم المرفق----- </h3>
            ...
            <table class="table table-hover table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th span="1" style="width: 20%">الدائرة/الفئة</th>
                  <th span="1" style="width: 20%">العدد اللازم حسب المفتاح</th>
                  <th span="1" style="width: 20%">المتوفر</th>
