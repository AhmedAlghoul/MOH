...
@section('small-page-name','عرض الدوائر')
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">عرض الدوائر </h3>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a class="btn btn-success" style="width: 250px;" href="{{route('circlesexport')}}">تصدير
              اكسل</a> 
            ...
            <table class="table table-hover table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th span="1" style="width: 20%">اسم الدائرة</th>
                  <th>الفعالية</th>
                  <th> الأوامر</th>
                </tr>
              </thead>
