...
@section('title','إضافة دائرة جديدة')
...
@section('page-name','إضافة دائرة جديدة')

@section('small-page-name','إضافة دائرة')
...
<div class="col-md-12">
  ...
  <div class="card card-primary" id="form-card">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="create-form" role="form" method="POST" action="{{route('circle.store')}}">
