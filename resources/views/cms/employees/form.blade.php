      ...
      <div class="card-body form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <select class="form-control" id="hospital-choice" name="hospital">
            <option name="hospital" id="hospital-choice" selected> اختر المستشفى </option> @foreach ($hospitals as
            $hospital)
        ...
        <div class="form-group col-md-6">
          ...
          <select class="form-control" id="circle-choice" name="circle">
            <option name="circle" id="circle-choice" selected> اختر الدائرة </option> @foreach ($circles as
            $circle)
